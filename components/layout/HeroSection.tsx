...
export default function HeroSection() {
  return (
    ...
    >
      ...
      >
        <motion.div
          className='absolute top-1/4 -left-40 w-[500px] h-[500px] rounded-full blur-3xl brand-gradient opacity-20'
          animate={{ x: [0, 30, 0], y: [0, -20, 0], scale: [1, 1.1, 1] }}
          transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut' }}
        />
        <motion.div
          className='absolute bottom-1/4 -right-40 w-[500px] h-[500px] rounded-full blur-3xl brand-gradient opacity-10'
      ...
      <div className='container mx-auto px-6 py-32 relative z-10'>
        ...
        >
          ...
          <motion.div
            ...
            variants={itemVariants}
          >
            <Button size='lg' asChild className='px-8 py-6 w-full sm:w-auto bg-violet-500 hover:bg-purple-600 text-white border-0 transition-colors'>
              <Link
                href='#projects'
