      ...
      <article className="container mx-auto px-6 py-32 max-w-4xl">
        ...
        <section className="mb-12 p-6 bg-violet-500/10 rounded-2xl border border-violet-500/20">
          ...
          <p className="text-muted-foreground">
            <strong className="text-foreground">
              Mpho Moipolai (mpho-moipolai.co.za)
            </strong>{' '}
            collects minimal personal information through contact forms. We use
            your information solely to respond to inquiries and provide
            services. We do not sell, rent, or share your data with third
            parties. This site complies with the POPIA (South Africa) and GDPR
            (EU) regulations.
          </p>
        </section>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="flex items-start gap-3 p-4 bg-muted/30 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Name, email, phone (optional), project details via contact
                  form only
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-muted/30 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Secure servers, encrypted transmission, retained only as
                  needed
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-4 bg-muted/30 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Access, correct, delete your data at any time
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12 prose prose-lg max-w-none">
          ...
          <p className="text-muted-foreground mb-6">
            ...
            parties. Your data is never used for advertising or marketing
            purposes by external parties. We may share information with trusted
            service providers (such as hosting providers) who assist in
            operating our website, but they are bound by confidentiality
            obligations.
          </p>
          ...
          <p className="text-muted-foreground mb-6">
            ...
            interact with our content. Google Analytics collects anonymous data
            such as pages visited, time on site, and referral sources. You can
            opt out of Google Analytics using browser extensions. We use
            essential cookies for website functionality but do not use tracking
          ...
          <p className="text-muted-foreground mb-6">
            ...
            the purposes outlined in this policy. Contact form submissions are
            typically retained for 12 months. Client project data is retained
            for the duration of the business relationship plus 5 years for legal
            compliance.
          </p>

          <h2 className="text-2xl font-bold mb-4">
            7. Your Rights (POPIA and GDPR)
          </h2>
          <p className="text-muted-foreground mb-4">
            Under the Protection of Personal Information Act (POPIA) in South
            Africa and the General Data Protection Regulation (GDPR) in the EU,
          ...
          <p className="text-muted-foreground mb-6">
            ...
            updated&quot; date at the top indicates the most recent revision. We
        ...
        <section className="text-center mt-12 pt-8 border-t">
          <Link href="/terms" className="text-violet-500 hover:underline mr-6">
            Terms of Service
          </Link>
