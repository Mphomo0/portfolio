...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_ZA',
    type: 'website',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Next.js Website Design Midrand | Mpho Moipolai' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Next.js Developer Midrand | Fast Websites | Mpho Moipolai',
    description: 'Next.js websites in Midrand, South Africa. Server-side rendering and built-in SEO for blazing-fast, high-ranking business websites.',
    creator: '@gift187',
