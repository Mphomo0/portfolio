...
export const metadata: Metadata = {
  ...
  description: 'Custom ecommerce development in Midrand, South Africa. Secure online stores with PayFast and Peach Payments integration for growing businesses.',
  alternates: {
    canonical: 'https://www.mpho-moipolai.co.za/ecommerce-website-development',
  },
  openGraph: {
    ...
    locale: 'en_ZA',
    type: 'website',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Ecommerce Website Development Midrand | Mpho Moipolai' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Ecommerce Development Midrand | Mpho Moipolai',
    description: 'Custom ecommerce development in Midrand. Secure online stores with PayFast and Peach Payments for South African businesses.',
    creator: '@gift187',
    ...
    '@graph': [
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Ecommerce Development', item: 'https://www.mpho-moipolai.co.za/ecommerce-website-development' },
        ],
      },
      {
        "@type": "Service",
